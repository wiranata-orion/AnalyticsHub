...
// Penyaringan di klien selama data masih placeholder. Saat API tersedia, ini
// berpindah jadi parameter query dan halaman menerima hasil yang sudah tersaring.
...
<template>
    <AppLayout>
        ...
        <AppCard flush>
            <!-- Kontrol penyaringan dalam satu baris di atas tabel -->
            <div
                class="flex flex-wrap items-center gap-3 border-b border-hairline px-5 py-3 dark:border-hairline-dark"
            >
            ...
            >
                <template #action>
                    <AppButton icon="refresh" @click="resetFilters">
                        Reset Filter
                    </AppButton>
                </template>
            </EmptyState>
